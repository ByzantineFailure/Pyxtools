...
def getArgs():
    ...
    dcardtypepg.add_argument('--id', type=int, help='Card id (for delete)', required = True)
    ...
    importparser.add_argument('-s', '--cardset', type=int, help='Cardset id to insert as (fails if already exists)')
